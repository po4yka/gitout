"""Behavioral spec for the retry policy (port of RetryPolicyTest.kt).
...
Red until ``gitout.retry`` is implemented in Phase 1 (failures are either
NotImplementedError or "DID NOT RAISE" where validation is not yet wired).
"""
